...
/** Class controls add product form window for inventory management system.*/
public class AddProductController implements Initializable {
    ...
    /** RUNTIME ERROR - Saves part information onto inventory.
    ...
    public void onActionSaveProduct(ActionEvent event) throws IOException {
        try {
            int id = Inventory.lastProductInvId();
    ...
    /** Method initializes add product form. All parts listed on inventory are populated in parts table. Product ID
     * field is disabled and default text is entered indicating ID is auto generated.
     */
    @Override
